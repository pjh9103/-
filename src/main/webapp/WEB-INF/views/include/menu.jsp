...
<div class="w3-bar w3-black">
	<div id="blogMenu">
		...
		<ul>
			...
			<li><a href="${path}/shop/product/list5.do">상품목록</a>

				<ul>
					<li><a href="${path}/shop/product/list.do">아이언 맨</a></li>
					<li><a href="${path}/shop/product/list2.do">배트맨</a></li>
					<li><a href="${path}/shop/product/list3.do">스파이더맨</a></li>
					<li><a href="${path}/shop/product/list4.do">슈퍼맨</a></li>
				</ul></li>
