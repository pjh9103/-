	...
	<div id="blogMenu">
		<ul>
			...
			<li><a href="${path}/shop/product/list.do">상품목록</a>
				...
				<ul>
					<li><a href="${path}/shop/product/list.do">케릭터</a></li>
					<li><a href="${path}/shop/product/list2.do">건축물</a></li>
					<li><a href="${path}/shop/product/list3.do">미니 카</a></li>
					<li><a href="${path}/shop/product/list4.do">항공기</a></li>
				</ul></li>
